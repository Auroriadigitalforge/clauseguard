...
export const LegalGlossary: React.FC<LegalGlossaryProps> = ({
  ...
  return (
    <section
      ...
      aria-labelledby="legal-glossary-heading"
    ...
    >
      ...
      <div
        ...
        aria-controls="legal-glossary-content-panel"
        ...
        className="p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer hover:bg-slate-50/70 transition-colors select-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
      >
        <div className="flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-indigo-50 border border-indigo-200 flex items-center justify-center shrink-0 mt-0.5" aria-hidden="true">
          ...
          <div>
            ...
            <h3 id="legal-glossary-heading" className="text-xl font-bold text-slate-900 tracking-tight mt-0.5">
      ...
      {isSectionOpen && (
        <div id="legal-glossary-content-panel" role="region" aria-labelledby="legal-glossary-heading" className="p-5 sm:p-6 pt-0 border-t border-slate-100 space-y-5 animate-in fade-in duration-200">
          {/* Controls: Search + Actions */}
          <div className="pt-4 flex flex-col md:flex-row md:items-center justify-between gap-3">
            {/* Search Input */}
            <div role="search" className="relative flex-1 max-w-md">
              ...
              <input
                ...
                aria-label="Search legal terms and dictionary definitions"
            ...
            <div className="flex items-center gap-2 self-start md:self-auto" role="toolbar" aria-label="Glossary display options">
              <button
                id="glossary-expand-all-btn"
                type="button"
                onClick={handleExpandAll}
                aria-label="Expand all dictionary terms"
                className="px-2.5 py-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-slate-400"
              >
                Expand All
              </button>
              <button
                ...
                aria-label="Collapse all dictionary terms"
                className="px-2.5 py-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-slate-400"
              >
                Collapse All
              </button>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      aria-controls={`glossary-details-${term.id}`}
                      ...
                      className="p-4 flex items-start justify-between gap-3 cursor-pointer select-none focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-t-xl"
                    >
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                          ...
                          {isDetectedInDocument && (
                            <span className="px-2 py-0.5 rounded-md text-3xs font-bold bg-indigo-100 text-indigo-800 border border-indigo-200 flex items-center gap-1">
                              <Sparkles className="w-2.5 h-2.5 text-indigo-600" aria-hidden="true" />
                    ...
                    {isExpanded && (
                      <div id={`glossary-details-${term.id}`} className="px-4 pb-4 pt-1 border-t border-slate-100/90 space-y-3.5 text-xs animate-in fade-in duration-150">
